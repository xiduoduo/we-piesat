export const Util = {
	...
	createTexture: function (options, typedArray) {
	...
	createFramebuffer: function (context, colorTexture, depthTexture) {
	...
	createRawRenderState: function (options) {
	...
	viewRectangleToLonLatRange: function (viewRectangle) {
		var range = {};
