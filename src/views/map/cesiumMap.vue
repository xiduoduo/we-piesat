...
export default {
      ...
      methods: {
            ...
            init: function (type) {
                  ...
                  // });
                  viewer.camera.flyTo({
                        destination: this.$route.path=="/temperatureDiolag"?Cesium.Cartesian3.fromDegrees(118.767,32.041, 1223281):Cesium.Cartesian3.fromDegrees(114.84, 26.15, 12315773),
                        orientation: {
